...
class HomeViewModelTest {
    ...
    private val clientUser = UserModel(
        id = "3",
        username = "func",
    ...
    @Test
    fun `initial state has title Sprena`() = runTest {
        val vm = createVm()
        assertEquals("Sprena", vm.uiState.first().title)
    }

    @Test
    fun `initial state has default subtitle`() = runTest {
        val vm = createVm()
    ...
    @Test
    fun `initial state has CLIENT role`() = runTest {
        val vm = createVm()
    ...
    @Test
    fun `UserLoaded ADM sets title to Painel Admin`() = runTest {
        val vm = createVm()
    ...
    @Test
    fun `UserLoaded ADM sets subtitle with name and full access`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(admUser))
    ...
    @Test
    fun `UserLoaded ADM sets userRole to ADM`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(admUser))
    ...
    @Test
    fun `UserLoaded ADM preserves userName`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(admUser))
    ...
    @Test
    fun `UserLoaded MOD sets title to Painel Moderador`() = runTest {
        val vm = createVm()
    ...
    @Test
    fun `UserLoaded MOD sets subtitle with name and event management`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(modUser))
        val subtitle = vm.uiState.first().subtitle
    ...
    @Test
    fun `UserLoaded MOD sets userRole to MOD`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(modUser))
    ...
    @Test
    fun `UserLoaded MOD preserves userName`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(modUser))
    ...
    @Test
    fun `UserLoaded CLIENT sets title to Sprena`() = runTest {
        val vm = createVm()
    ...
    @Test
    fun `UserLoaded CLIENT sets subtitle with name and activity tracking`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(clientUser))
        val subtitle = vm.uiState.first().subtitle
    ...
    @Test
    fun `UserLoaded CLIENT sets userRole to CLIENT`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(clientUser))
        assertEquals(UserRole.CLIENT, vm.uiState.first().userRole)
    }
    ...
    @Test
    fun `UserLoaded CLIENT preserves userName`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(clientUser))
    ...
    @Test
    fun `UserLoaded can switch from ADM to CLIENT`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(admUser))
        assertEquals(UserRole.ADM, vm.uiState.first().userRole)
    ...
    @Test
    fun `UserLoaded can switch from CLIENT to MOD`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(clientUser))
        vm.onEvent(HomeUiEvent.UserLoaded(modUser))
        assertEquals(UserRole.MOD, vm.uiState.first().userRole)
    ...
    @Test
    fun `OnRefresh sets loading to false`() = runTest {
        val vm = createVm()
    ...
    @Test
    fun `OnRefresh preserves user data`() = runTest {
        val vm = createVm()
        vm.onEvent(HomeUiEvent.UserLoaded(admUser))
        vm.onEvent(HomeUiEvent.OnRefresh)
