...
class LoginUseCaseTest {
    ...
    @Test
    fun `empty username returns Error without calling repository`() = runTest {
        val result = useCase("", "123456")
        assertTrue(result is AuthResult.Error)
    }

    @Test
    fun `username too short returns Error`() = runTest {
        val result = useCase("ab", "123456")
        assertTrue(result is AuthResult.Error)
    }

    @Test
    fun `username too long returns Error`() = runTest {
        val result = useCase("123456789", "123456")
        assertTrue(result is AuthResult.Error)
    }

    @Test
    fun `password with letters returns Error`() = runTest {
        val result = useCase("admin", "abc123")
        assertTrue(result is AuthResult.Error)
    }

    @Test
    fun `password too short returns Error`() = runTest {
        val result = useCase("admin", "12345")
        assertTrue(result is AuthResult.Error)
    }

    @Test
    fun `password too long returns Error`() = runTest {
    ...
    @Test
    fun `valid admin credentials return Success with ADM role`() = runTest {
    ...
    @Test
    fun `valid mod credentials return Success with MOD role`() = runTest {
    ...
    @Test
    fun `valid client credentials return Success with CLIENT role`() = runTest {
    ...
    @Test
    fun `wrong password returns Error`() = runTest {
    ...
    @Test
    fun `unknown user returns Error`() = runTest {
